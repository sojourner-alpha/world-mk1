        ...
        <div className="container-custom">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <span className="text-blue-600 text-sm">Loft</span>
            </nav>
          </div>
        </div>
      </header>
        ...
        <div className="container-custom relative z-20 h-full flex items-center">
          <div className="max-w-2xl">
            <div className="bg-matted/60 backdrop-blur-sm text-white p-8 rounded-lg">
              ...
              <p className="text-xl mb-6">Hobbies & creative pursuits</p>
              <p className="mb-6">A vibrant studio space that houses creative pursuits, hobbies, and artistic expressions beyond the professional realm.</p>
              <div className="mt-6">
      ...
      <section className="py-16 bg-white">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-heading mb-8 text-center">Creative Expressions</h2>
            
            <div className="bg-parchment p-8 rounded-lg shadow-md mb-12">
              <p className="text-lg mb-6">
                This section features a gallery of creative projects, music, writing, 
                and other passion-driven work that showcases the more personal side of creativity.
              </p>
              <p>
                Loft unveils creative pursuits that fuel imagination and remind us that 
                technology serves human expression. Here creativity meets technical expertise 
                in unexpected ways.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-parchment p-6 rounded-lg shadow-md fade-in-up">
                <h3 className="text-xl font-heading mb-4">Creative Gallery</h3>
                <p>
                  A curated collection of artistic projects, experimental works, 
                  and creative expressions across various media and formats.
                </p>
                <div className="mt-4 text-blue-600">Coming soon</div>
              </div>
              
              <div className="bg-parchment p-6 rounded-lg shadow-md fade-in-up">
                <h3 className="text-xl font-heading mb-4">Passion Projects</h3>
                <p>
                  An exploration of personal interests, side projects, and hobbies
                  that provide balance and inspire creativity in all aspects of life.
                </p>
                <div className="mt-4 text-blue-600">Coming soon</div>
              </div>
            </div>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-heading mb-6">Visit The Loft</h2>
