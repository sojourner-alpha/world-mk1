        ...
        <div className="container-custom relative z-20 h-full flex items-center">
          <div className="max-w-2xl">
            <div className="bg-matted/60 backdrop-blur-sm text-white p-8 rounded-lg">
              ...
              <p className="text-xl mb-6">Connection & community</p>
              <p className="mb-6">A central meeting place designed for connection, collaboration, and community engagement.</p>
              <div className="mt-6">
      ...
      <section className="py-16 bg-white">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-heading mb-8 text-center">Let's Connect</h2>
            
            <div className="bg-parchment p-8 rounded-lg shadow-md mb-12">
              <p className="text-lg mb-6">
                This is where you can reach out for collaborations, leave your mark on an interactive
                visitor map, or find various ways to connect through social channels.
              </p>
              <p>
                Crossroads serves as a digital intersection where paths meet and new journeys begin,
                facilitating meaningful connections and conversations.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-parchment p-6 rounded-lg shadow-md fade-in-up">
                ...
                <p>
                  Interested in discussing a project, collaboration, or just want to connect?
                  Reach out through the contact form or social channels.
                </p>
                <div className="mt-4 text-blue-600">Coming soon</div>
              </div>
              
              <div className="bg-parchment p-6 rounded-lg shadow-md fade-in-up">
                <h3 className="text-xl font-heading mb-4">Community Map</h3>
                <p>
                  An interactive visitor map showing where visitors have connected from 
                  around the world, creating a visual representation of our global community.
                </p>
                <div className="mt-4 text-blue-600">Coming soon</div>
              </div>
            </div>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-heading mb-6">Meet At The Crossroads</h2>
