                ...
                <div className="bg-slate-800 rounded-lg shadow-md overflow-hidden">
                  <div className="p-4 border-b border-slate-700">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center">
                        <span className="text-slate-400 text-xs mr-2">Discord</span>
                        <div className="flex items-center gap-1 bg-blue-600/20 text-blue-400 rounded-full px-2 py-1 text-xs">
                  ...
                  <div className="flex flex-col sm:flex-row">
                    ...
                    <div className="sm:w-1/2 relative">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-3">
                        <h3 className="text-white font-medium">sojourner-alpha</h3>
                        <p className="text-white/70 text-xs">Ready for adventure</p>
                      </div>
                    </div>
                    ...
                    <div className="rounded-lg overflow-hidden shadow-sm bg-white border border-slate-200">
                      <div className="p-3">
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <div className="bg-purple-500 text-white text-xs px-1.5 py-0.5 rounded text-center">
                            Babylon.js
                          </div>
                        </div>
                        <p className="text-xs text-slate-600 mt-1">Orbital habitat simulation</p>
                    ...
                    <div className="rounded-lg overflow-hidden shadow-sm bg-white border border-slate-200">
                      <div className="p-3">
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <div className="bg-green-500 text-white text-xs px-1.5 py-0.5 rounded text-center">
                            A-Frame
                          </div>
                        </div>
                        <p className="text-xs text-slate-600 mt-1">Underwater ecosystem</p>
                        <div className="flex justify-between items-center mt-3">
                          <span className="text-xs bg-amber-100 text-amber-800 px-2 py-0.5 rounded-full">Coming Soon</span>
