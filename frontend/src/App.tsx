    ...
    <div className="container-wide relative z-10 h-full flex items-center">
      <div className="max-w-lg ml-auto mr-20 text-white">
        <div className="content-container content-container-right">
          ...
          <div className="content-text">
            <div className="text-left w-full">
              <p className="text-lg mb-6">My learning space. Dedicated to educational content and a journey through various disciplines. Where deep thinking,analysis and synthesis happens. </p>
            </div>
